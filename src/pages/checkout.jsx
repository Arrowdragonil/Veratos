  ...
  <section className="checkout p-5">
    <div className="container-xxl">
      <div className="row">
        ...
        <h1 className="mb-4 fs-3">Tipo de pago</h1>
      ...
      <div className="col-md-6 p-2">
            <h1 className=" mt-3 mb-3 fs-3">rellena los detalles de la compra.</h1>
            <form className="row g-3 mb-3">
              ...
              <div className="col-12 mt-5">
                <button id="button-linker" type="submit" onClick={handlePay}>Finaliza el pago</button>
              </div>
            </form>
          </div>
        </div>
